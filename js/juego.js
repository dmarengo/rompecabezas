...
var instrucciones = ["Utiliza las flechas para mover las piezas", "Para finalizar deberas jugar hasta armar el rompecabezas"];
...
function mostrarCartelGanador() {
    alert("Felicitaciones, has podido completar el Rompecabezas!!!");
}
...
function moverEnDireccion(direccion) {
  ...
  // Mueve la pieza hacia abajo, reemplazandola con la vacia
  if (direccion === codigosDireccion.ABAJO) {
    nuevaFilaPiezaVacia = filaVacia + 1;
    nuevaColumnaPiezaVacia = columnaVacia;
  }
    
  // Mueve la pieza hacia arriba, reemplazandola con la vacia
  else if (direccion === codigosDireccion.ARRIBA) {
    nuevaFilaPiezaVacia = filaVacia - 1;
    nuevaColumnaPiezaVacia = columnaVacia;
  }
    
  // Mueve la pieza hacia la derecha, reemplazandola con la vacia
  else if (direccion === codigosDireccion.DERECHA) {
    nuevaFilaPiezaVacia = filaVacia;
    nuevaColumnaPiezaVacia = columnaVacia + 1;
  }

  // Mueve la pieza hacia la izquierda, reemplazandola con la vacia
